...
{
    internal static class CobraFfbDeviceProbe
    {
        ...
        public static List<DynamicDropdownOption> GetDevices()
        {
            ...
            var cobraDirectory = Path.Combine(Directory.GetCurrentDirectory(), "TeknoCobra");
            var probePath = Path.Combine(cobraDirectory, "CobraHaptic.exe");
            ...
            try
            {
                using (var process = new Process
                {
                    StartInfo = new ProcessStartInfo(probePath, "--list")
                    {
                        ...
                        WorkingDirectory = cobraDirectory,
            ...
            {
                // Older TeknoCobra packages may not include the optional haptic probe.
            }
