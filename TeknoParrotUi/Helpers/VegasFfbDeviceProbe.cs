...
{
    internal static class VegasFfbDeviceProbe
    {
        ...
        public static List<DynamicDropdownOption> GetDevices()
        {
            ...
            var vegasDirectory = Path.Combine(Directory.GetCurrentDirectory(), "TeknoVegas");
            var probePath = Path.Combine(vegasDirectory, "vegashaptic.exe");
            ...
            try
            {
                using (var process = new Process
                {
                    StartInfo = new ProcessStartInfo(probePath, "--list")
                    {
                        ...
                        WorkingDirectory = vegasDirectory,
            ...
            {
                // Older TeknoVegas packages may not include the optional haptic probe.
            }
