...
{
    internal static class Hng64FfbDeviceProbe
    {
        ...
        public static List<DynamicDropdownOption> GetDevices()
        {
            ...
            var hng64Directory = Path.Combine(Directory.GetCurrentDirectory(), "TeknoHNG64");
            var probePath = Path.Combine(hng64Directory, "HNG64haptic.exe");
            ...
            try
            {
                using (var process = new Process
                {
                    StartInfo = new ProcessStartInfo(probePath, "--list")
                    {
                        ...
                        WorkingDirectory = hng64Directory,
