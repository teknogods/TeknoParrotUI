...
{
    internal static class ZeusFfbDeviceProbe
    {
        ...
        public static List<DynamicDropdownOption> GetDevices()
        {
            ...
            var zeusDirectory = Path.Combine(Directory.GetCurrentDirectory(), "TeknoZeus");
            var probePath = Path.Combine(zeusDirectory, "zeushaptic.exe");
            ...
            try
            {
                using (var process = new Process
                {
                    StartInfo = new ProcessStartInfo(probePath, "--list")
                    {
                        ...
                        WorkingDirectory = zeusDirectory,
            ...
            {
                // Older TeknoZeus packages may not include the optional haptic probe.
            }
