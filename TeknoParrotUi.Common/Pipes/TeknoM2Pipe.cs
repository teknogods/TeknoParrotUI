...
namespace TeknoParrotUi.Common.Pipes
{
    ...
    public sealed class TeknoM2Pipe : ControlSender
    {
        ...
        private static bool GunProfile() => InputCode.GameProfile?.GunGame == true;
