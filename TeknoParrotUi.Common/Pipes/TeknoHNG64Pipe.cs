...
namespace TeknoParrotUi.Common.Pipes
{
    ...
    public sealed class TeknoHNG64Pipe : ControlSender
    {
        ...
        private static byte ExtraByte(int index)
        {
            ...
            if (Down(input.Service)) value |= 0x10;
            if (Down(input.ExtensionButton2)) value |= 0x20;
            return value;
        }
