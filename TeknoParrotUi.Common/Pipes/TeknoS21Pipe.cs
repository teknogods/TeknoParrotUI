...
namespace TeknoParrotUi.Common.Pipes
{
    ...
    public sealed class TeknoS21Pipe : ControlSender
    {
        ...
        public override void Start()
        {
            ...
            for (var axis = 0; axis < 8; ++axis) InputCode.AnalogBytes[axis * 2] = 0x80;
            if (new[] { "winrun", "winrungp", "winrun91", "driveyes" }.Contains(InputCode.GameProfile?.ProfileName))
            {
