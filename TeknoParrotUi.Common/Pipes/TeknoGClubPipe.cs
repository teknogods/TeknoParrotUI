...
namespace TeknoParrotUi.Common.Pipes
{
    ...
    public sealed class TeknoGClubPipe : ControlSender
    {
        ...
        public override void Start()
        {
            ...
            if (set == "gticlub") { InputCode.AnalogBytes[2] = 0; InputCode.AnalogBytes[4] = 0; }
            base.Start();
        }
