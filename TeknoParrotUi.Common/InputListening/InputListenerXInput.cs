        ...
        public void ListenXInput(bool useSto0Z, int stoozPercent, List<JoystickButtons> joystickButtons, UserIndex index, GameProfile gameProfile)
        {
            ...
            try
            {
                ...
                if (_gameProfile.EmulationProfile == EmulationProfile.Daytona3 || _gameProfile.EmulationProfile == EmulationProfile.EuropaRFordRacing || _gameProfile.EmulationProfile == EmulationProfile.EuropaRSegaRally3 || _gameProfile.EmulationProfile == EmulationProfile.FNFDrift || _gameProfile.EmulationProfile == EmulationProfile.GRID ||
                    ...
                    _gameProfile.EmulationProfile == EmulationProfile.SegaToolsIDZ || _gameProfile.EmulationProfile == EmulationProfile.NamcoWmmt3 || _gameProfile.EmulationProfile == EmulationProfile.IDZ || _gameProfile.EmulationProfile == EmulationProfile.NamcoWmmt6RR || _gameProfile.EmulationProfile == EmulationProfile.Outrun2SPXElf2)
                {
                    InputCode.AnalogBytes[0] = 0x80;
                }
            ...
            switch (joystickButtons.InputMapping)
            {
                ...
                case InputMapping.P1ButtonRight:
                    if (!_gameProfile.UseDirectionalPresses || InputCode.ButtonMode == EmulationProfile.TaitoTypeXBattleGear)
                    {
                        ...
                        {
                            InputCode.PlayerDigitalButtons[0].Right = DigitalHelper.GetButtonPressXinput(button, state, index);
                        }
                    }
                    else
                ...
                case InputMapping.P2ButtonUp:
                    if (_gameProfile.UseDirectionalPresses)
                        ...
                        InputCode.PlayerDigitalButtons[1].Up = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.P2ButtonDown:
                    if (_gameProfile.UseDirectionalPresses)
                        ...
                        InputCode.PlayerDigitalButtons[1].Down = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.P2ButtonLeft:
                    if (_gameProfile.UseDirectionalPresses)
                        ...
                        InputCode.PlayerDigitalButtons[1].Left = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                ...
                case InputMapping.StreamHostP1ButtonStart:
                    InputCode.StreamingPlayerDigitalButtons[6].Start = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.StreamHostP1Button1:
                    InputCode.StreamingPlayerDigitalButtons[6].Button1 = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.StreamHostP1Button2:
                    InputCode.StreamingPlayerDigitalButtons[6].Button2 = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                ...
                case InputMapping.Stream2P1ButtonLeft:
                    InputCode.StreamingPlayerDigitalButtons[0].Left = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.Stream2P1ButtonRight:
                    InputCode.StreamingPlayerDigitalButtons[0].Right = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                ...
                case InputMapping.Stream3P1ButtonLeft:
                    InputCode.StreamingPlayerDigitalButtons[2].Left = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.Stream3P1ButtonRight:
                    InputCode.StreamingPlayerDigitalButtons[2].Right = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                ...
                case InputMapping.Stream4P1ButtonLeft:
                    InputCode.StreamingPlayerDigitalButtons[4].Left = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.Stream4P1ButtonRight:
                    InputCode.StreamingPlayerDigitalButtons[4].Right = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                ...
                case InputMapping.Card3:
                    InputCode.PlayerDigitalButtons[0].Card2 = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
                case InputMapping.Card4:
                    InputCode.PlayerDigitalButtons[1].Card2 = DigitalHelper.GetButtonPressXinput(button, state, index);
                    break;
